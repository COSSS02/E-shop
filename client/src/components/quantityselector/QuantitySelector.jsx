...
function QuantitySelector({ initialQuantity, maxQuantity, onQuantityChange }) {
    ...
    const handleQuantityUpdate = (newQuantity) => {
        ...
        // Only call the expensive API update if the value has actually changed
    ...
    const handleBlur = () => {
        // When the user clicks away, validate and trigger the update
        handleQuantityUpdate(quantity || 1); // Default to 1 if input is empty
    };
